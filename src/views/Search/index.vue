            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                ...
                <li :class="{active:isTwo}"  @click="changeOrder('2')">
                  <a>销量<span v-show="isOne" class="iconfont" :class="{'icon-UP':isAsc,'icon-DOWN':isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  // 当组件挂载完毕之前执行一次
  beforeMount() {
    // object.assign:合并的写法-----同名的属性（方法）会进行覆盖
